...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20181219_puertonatura_5e7231b4e25ec3f87386_20181219222408_archive.zip';
	const ARCHIVE_SIZE		 = '30727505';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = '5e7231b-19222408';
	const VERSION			 = '1.3.0';
	...
	public function run()
	{
		...
		self::log('==DUPLICATOR INSTALLER BOOTSTRAP v1.3.0==');
		self::log('----------------------------------------------------');
